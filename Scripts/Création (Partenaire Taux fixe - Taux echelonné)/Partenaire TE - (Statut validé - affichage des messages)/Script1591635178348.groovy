...
WebUI.setText(findTestObject('Object Repository/Création partenaire/Page_IAD/input__lastName'), 'Nassima' + intSeq)

WebUI.setText(findTestObject('Object Repository/Création partenaire/Page_IAD/input__mobilePhone'), '06 11 15 14 10')

WebUI.setText(findTestObject('Object Repository/Création partenaire/Page_IAD/input__phone'), '01 23 70 12 60')

WebUI.setText(findTestObject('Object Repository/Création partenaire/Page_IAD/input__email'), ('nassimat@' + intSeq) + 'hiit.com')

WebUI.setText(findTestObject('INFOS Contact partenaire/Page_IAD/input_Secteur_email'), 'test@email.com')

WebUI.click(findTestObject('Adrres contact/Page_IAD/input__address1'))

WebUI.setText(findTestObject('Adrres contact/Page_IAD/input__address1'), 'p')
