...
not_run: WebUI.click(findTestObject('Object Repository/Création partenaire/Page_IAD/span_Sauvegarder'))
...
not_run: WebUI.click(findTestObject('Editer un partenaire/Page_IAD/div_diter_myiad-burger-useful-width dropdown-toggle'))

not_run: WebUI.click(findTestObject('Editer un partenaire/Page_IAD/li_diter'))

not_run: WebUI.delay(5)

not_run: WebUI.click(findTestObject('Editer un partenaire/Page_IAD/div_Contacts'))
...
not_run: WebUI.setText(findTestObject('Object Repository/Création partenaire/Page_IAD/input__lastName'), 'Nassima' + intSeq)

not_run: WebUI.setText(findTestObject('Object Repository/Création partenaire/Page_IAD/input__mobilePhone'), '06 11 15 14 10')

not_run: WebUI.setText(findTestObject('Object Repository/Création partenaire/Page_IAD/input__phone'), '01 23 70 12 60')

not_run: WebUI.setText(findTestObject('Object Repository/Création partenaire/Page_IAD/input__email'), ('nassimat@' + intSeq) + 
    'hiit.com')

not_run: WebUI.setText(findTestObject('INFOS Contact partenaire/Page_IAD/input_Secteur_email'), 'test@email.com')

not_run: WebUI.click(findTestObject('Editer un partenaire/Page_IAD/input__address1'))

not_run: WebUI.setText(findTestObject('Editer un partenaire/Page_IAD/input__address1'), 'N')

not_run: WebUI.delay(1)

not_run: WebUI.sendKeys(findTestObject('Editer un partenaire/Page_IAD/input__address1'), Keys.chord(Keys.ARROW_DOWN))

not_run: WebUI.sendKeys(findTestObject('Editer un partenaire/Page_IAD/input__address1'), Keys.chord(Keys.ENTER))
